...
return (
    ...
    <Container fluid>
        ...
        <div className="flexRow image-wrapper" style={{ alignItems: "center"}}>
            <Image src={ProfilePic} objectFit="cover" alt="profile" width="50px" height="50px"/>
            <svg className="svgDropDown" width="16" height="9" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
